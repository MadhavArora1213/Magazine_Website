...
const Footer = () => {
  ...
  const footerLinks = {
    'Popular Sections': [
      { name: 'People & Profiles', path: '/people-profiles' },
      { name: 'Entertainment', path: '/entertainment' },
      { name: 'Lifestyle', path: '/lifestyle' },
      { name: 'Business & Leadership', path: '/business-leadership' },
      { name: 'Regional Focus', path: '/regional-focus' },
      { name: 'Special Sections', path: '/special-sections' }
    ],
    'Quick Links': [
      { name: 'Trending Now', path: '/trending' },
      { name: 'Featured Articles', path: '/featured' },
      { name: 'Video Content', path: '/videos' },
      { name: 'Photo Galleries', path: '/galleries' },
      { name: 'Events Calendar', path: '/events' },
      { name: 'Digital Magazine', path: '/flipbook' }
    ],
    'Resources': [
    ...
    'Legal': [
      ...
      { name: 'Copyright Info', path: '/copyright' },
      { name: 'Correction Policy', path: '/corrections' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4 leading-relaxed">
              Your premier destination for lifestyle, entertainment, business insights, and cultural stories from the UAE and beyond.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Get the latest news, exclusive interviews, and trending stories delivered to your inbox.
              </p>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col sm:flex-row items-center justify-between">
            <div className="mb-4 sm:mb-0">
              <h3 className="text-lg font-semibold text-white mb-1">Get Our Mobile App</h3>
              <p className="text-gray-400 text-sm">Read on the go with our mobile app</p>
            </div>
            <div className="flex space-x-3">
              <a
                href="#"
                className="flex items-center space-x-2 bg-black border border-gray-700 rounded-lg px-4 py-2 hover:border-gray-600 transition-colors duration-200"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              <p>© {currentYear} Magazine. All rights reserved. | Dubai, UAE</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between mt-4 pt-4 border-t border-gray-800">
            <div className="text-gray-500 text-xs mb-2 md:mb-0">
              Website designed and developed with ❤️ in Dubai
            </div>
