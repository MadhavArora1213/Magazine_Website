    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* About Column */}
          <div>
            <h3 className="text-2xl font-bold mb-6">Echo</h3>
            <p className="text-gray-400 mb-6">
              Echo is a modern magazine and news portal focusing on technology, lifestyle, 
              business and entertainment content for today's generation.
            </p>
          ...
          {/* Categories */}
          <div>
            <h4 className="text-lg font-semibold mb-6 border-b border-gray-700 pb-2">Categories</h4>
            <ul className="space-y-3">
          ...
          {/* Newsletter */}
          <div>
            <h4 className="text-lg font-semibold mb-6 border-b border-gray-700 pb-2">Newsletter</h4>
            ...
            <form className="flex flex-col space-y-3">
              <input 
                ...
                className="px-4 py-2 bg-gray-800 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-red-600 text-gray-300"
                required
              />
              <button 
                type="submit" 
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Echo Magazine. All rights reserved.
            </p>
            <div className="flex space-x-4">
